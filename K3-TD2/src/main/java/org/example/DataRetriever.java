...
public class DataRetriever {
    ...
    public Team findTeamById(Integer id) throws SQLException {
        ...
        String query = """
                select team.id as team_id, team.name as team_name,team.continent as team_continent,player.id as player_id, player.name as player_name,player.age as age,player.position as position from team
